...
namespace Book.Services.Services.Implementations
{
    public class MenuService
    {
        ...
        private User[] Users = { new User { UserName = "Fatali", Password = "Amirli" } };
        ...
        private async Task CreateBookWriter()
        {
            ...
            string message = await _bookWriterService.CreateAsync(name, surname, age, books);
        ...
        private async Task ShowBookWriterBooks()
        {
            ...
            List<Bookk> books = await _bookWriterService.GetAllBooksAsync(id);
            if (books != null)
            {
                foreach (Bookk book in books)
                {
        ...
        private async Task UpdateBookWriter()
        {
            ...
            string message = await _bookWriterService.UpdateAsync(Id, name, surname, age, books);
            Console.WriteLine(message);
        }
        ...
        private async Task CreateBook()
        {
            ...
            string message = await _bookService.CreateAsync(id, name, price, discountprice, bookInStock, category);
            Console.WriteLine(message);
        }
        ...
        private async Task UpdateBook()
        {
            ...
            string message2 = await _bookService.UpdateAsync(bookwriterId, bookId, name, price, discountprice, bookInStock);
        ...
        private async Task GetBookByBookWriter()
        {
            ...
            Bookk book = await _bookService.GetAsync(bookwriterId, bookId);
